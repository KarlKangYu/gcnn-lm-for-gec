...
class InputEngineRnn:
    ...
    def predict_data(self, sentence, k):
        ...
        words_line, letter_line,words_ids, words_num = self._data_utility.data2ids_line_only_words(sentence)
        out_str_list = []
        ...
        return words_line, letter_line,out_str_list, probability_topk_list
    ...
    #             words_line, out_words_list, out_prob_list = result
    #
